  ...
  return (
    <div className="page-inner-container work-page-main-container">
      <div className="work-previous">
        <h1 className="work-heading">Previous work experience:</h1>
        <div className="hr-line-70" />
        <WorkExperienceCard>
          <WorkExp
            name="Analytic Edge"
            gist="In a little over 2 years of my experience at this role, I have contributed across a suite of products and modules throughout the company using Typescript with React js with a graphql backend."
            from="July 2021"
